using GitGud.Analyzers.Nullable;
using GitGud.Analyzers.Tests.Nullable.Generators;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp.Testing;
using Microsoft.CodeAnalysis.Testing;
using Microsoft.CodeAnalysis.Testing.Verifiers;

namespace GitGud.Analyzers.Tests.Nullable;
...
public class NullKeywordUsageAnalyzerShould
{
    ...
    {
        var expectedDiagnostic = new DiagnosticResult("GUD001", DiagnosticSeverity.Warning)
